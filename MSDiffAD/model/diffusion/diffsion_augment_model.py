...
class DiffudionAugment(nn.Module):

    def __init__(self, device, args):
        super(DiffudionAugment, self).__init__()
        ...
        self.item_embedding = torch.nn.Embedding(100002, args.hidden_size, padding_idx=0)
    ...
    def diffusion_reverse(self, x, timesteps, attention_mask):
        ...
        input_trans_hidden_states = self.bert_encoder(emb_inputs, attention_mask, output_hidden_states=False,
    ...
    def calculate_cl_loss(self, aug_seq1, aug_seq2, emb1=None, emb2=None):
        ...
        nce_logits, nce_labels = info_nce(seq1_output, seq2_output, temp=self.args.temperature,
                                          batch_size=aug_seq1.shape[0], sim="dot")
