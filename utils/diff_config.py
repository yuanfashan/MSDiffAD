...
def get_config():
    ...
    parser.add_argument("--dataset", default="Beauty",
                        choices=['ml-1m', 'Beauty', 'Sports_and_Outdoors', 'Yelp', 'Toys_and_Games'],
    ...
    parser.add_argument("--data_path", default="./CaDiRec/data/", help="Choose the dataset path")
    parser.add_argument("--output_dir", default="./CaDiRec/saved_models/", help="save the model")
    ...
    # 使用
    parser.add_argument("--rescale_timesteps", type=bool, default=False)  # 改为 False，让梯度更陡峭
    parser.add_argument("--timestep_respacing", default="100")
